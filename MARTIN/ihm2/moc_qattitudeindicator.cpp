...
static const char qt_meta_stringdata_qAttitudeIndicator[] = {
    "qAttitudeIndicator\0"
};
...
const QMetaObjectExtraData qAttitudeIndicator::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject qAttitudeIndicator::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_qAttitudeIndicator,
      qt_meta_data_qAttitudeIndicator, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &qAttitudeIndicator::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_qAttitudeIndicator))
