...
static const char qt_meta_stringdata_QBase[] = {
    "QBase\0\0bEnable\0enableCamera(bool)\0"
};

void QBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        QBase *_t = static_cast<QBase *>(_o);
        switch (_id) {
        case 0: _t->enableCamera((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData QBase::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QBase::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QBase,
      qt_meta_data_QBase, &staticMetaObjectExtraData }
};
